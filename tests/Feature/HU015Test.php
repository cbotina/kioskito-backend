...
class HU015Test extends TestCase
{
    use RefreshDatabase;
   ...
   public function test_solicitar_pedido_campos_completos(): void {
   ...
   public function test_pedido_sin_productos(): void {
       $tokenClient = $this->post('/api/login', [
           "email" => "cliente@gmail.com",
           "password" => "12345678",
       ])->json('token');
   ...
   public function test_pedido_sin_nombre(): void {
       $tokenClient = $this->post('/api/login', [
           "email" => "cliente@gmail.com",
           "password" => "12345678",
       ])->json('token');
